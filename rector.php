...
return RectorConfig::configure()
    ...
    ->withSkip([
        ...
        // Matches by property NAME, so any `->title`/`->name` read whose type Rector cannot
        // infer is silently rewritten into a method call that does not exist. This repo
        // writes `fake()->word()` already, so the rule buys nothing and corrupts tests.
